...
Source0:	http://zope.org/Members/jmo/%{zope_subname}/%{zope_subname}-%{version}-%{sub_ver}/%{zope_subname}%{version}-%{sub_ver}.tgz
# Source0-md5:	d97c6c3ebec6444de386458ab66abad9
